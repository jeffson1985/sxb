...
public interface Session {
	...
	/**
	 * Gets the attribute names that have a value associated with it. Each value can be passed into {@link org.sxb.session.Session#getAttribute(String)} to obtain the attribute value.
	 *
	...
	/**
	 * Sets the attribute value for the provided attribute name. If the attributeValue is null, it has the same result as removing the attribute with {@link org.sxb.session.Session#removeAttribute(String)} .
	 *
