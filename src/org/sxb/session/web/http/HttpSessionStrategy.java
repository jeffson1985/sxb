 ...
 * the License.
 */
package org.sxb.session.web.http;
...
public interface HttpSessionStrategy {
	 ...
	 * may wish to add the IP Address, browser headers, the username, etc to the {@link org.sxb.session.Session}.
	 *
	 * @param session the {@link org.sxb.session.Session} that is being sent to the client. Cannot be null.
	 * @param request the {@link javax.servlet.http.HttpServletRequest} that create the new {@link org.sxb.session.Session} Cannot be null.
	 * @param response the {@link javax.servlet.http.HttpServletResponse}  that is associated with the {@link javax.servlet.http.HttpServletRequest} that created the new {@link org.sxb.session.Session} Cannot be null.
	 */
	 ...
	 *
	 * @param request the {@link javax.servlet.http.HttpServletRequest} that invalidated the {@link org.sxb.session.Session} Cannot be null.
	 * @param response the {@link javax.servlet.http.HttpServletResponse}  that is associated with the {@link javax.servlet.http.HttpServletRequest} that invalidated the {@link org.sxb.session.Session} Cannot be null.
	 */
