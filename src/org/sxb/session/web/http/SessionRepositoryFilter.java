...
import org.sxb.session.SessionRepository;

/**
 * Switches the {@link javax.servlet.http.HttpSession} implementation to be backed by a {@link org.sxb.session.Session}.
 *
 * The {@link SessionRepositoryFilter} wraps the {@link javax.servlet.http.HttpServletRequest} and overrides the methods
 * to get an {@link javax.servlet.http.HttpSession} to be backed by a {@link org.sxb.session.Session} returned
 * by the {@link org.sxb.session.SessionRepository}.
 *
 * The {@link SessionRepositoryFilter} uses a {@link HttpSessionStrategy} (default {@link CookieHttpSessionStrategy}  to
 * bridge logic between an {@link javax.servlet.http.HttpSession} and the {@link org.sxb.session.Session}
 ...
 *     <li>The session id of newly created {@link org.sxb.session.ExpiringSession} is sent to the client using
...
public class SessionRepositoryFilter<S extends ExpiringSession> extends OncePerRequestFilter {
	 ...
	 * {@link org.sxb.session.SessionRepository}.
	 *
	 * @author Jeffson
	 * @since 1.0
	 */
