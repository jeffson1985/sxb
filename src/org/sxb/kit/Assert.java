...
public abstract class Assert {
	 ...
	 * @param message the exception message to use if the assertion fails
	 * @see StringKits#hasLength
	 */
	public static void hasLength(String text, String message) {
		if (!StringKits.hasLength(text)) {
			throw new IllegalArgumentException(message);
		}
	}
	 ...
	 * @param text the String to check
	 * @param message the exception message to use if the assertion fails
	 * @see StringKits#hasText
	 */
	public static void hasText(String text, String message) {
		if (!StringKits.hasText(text)) {
			throw new IllegalArgumentException(message);
		}
	}
	...
	public static void doesNotContain(String textToSearch, String substring, String message) {
		if (StringKits.hasLength(textToSearch) && StringKits.hasLength(substring) &&
	...
	public static void notEmpty(Collection<?> collection, String message) {
		if (CollectionKits.isEmpty(collection)) {
			throw new IllegalArgumentException(message);
		}
	}
	...
	public static void isInstanceOf(Class<?> type, Object obj, String message) {
		...
		if (!type.isInstance(obj)) {
			throw new IllegalArgumentException(
					(StringKits.hasLength(message) ? message + " " : "") +
