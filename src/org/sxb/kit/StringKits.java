...
import org.sxb.ext.kit.jp.HankakuComparator;
import org.sxb.ext.kit.jp.KanaMapTable;
 ...
 * @since 16 April 2001
 * 
 * Modified by Jeffson   10 April 2015
 * 日语全半角功能追加
 */
public abstract class StringKits {
	...
	public static String[] concatenateStringArrays(String[] array1,
			String[] array2) {
		if (ObjectKits.isEmpty(array1)) {
			return array2;
		}
		if (ObjectKits.isEmpty(array2)) {
			return array1;
		}
	...
	public static String collectionToDelimitedString(Collection<?> coll,
		...
		if (CollectionKits.isEmpty(coll)) {
			return "";
		}
		StringBuilder sb = new StringBuilder();
	...
	public static String arrayToDelimitedString(Object[] arr, String delim) {
		if (ObjectKits.isEmpty(arr)) {
			return "";
		}
		if (arr.length == 1) {
			return ObjectKits.nullSafeToString(arr[0]);
		}
		StringBuilder sb = new StringBuilder();
	...
	public static String convertH2ZKana(String str, int pos, int length) {
		char[][][] table = KanaMapTable.TABLE_HANKAKU2ZENKAKU;
		Comparator<Object> comp = new HankakuComparator<Object>();
		...
		while (pos < maxPos) {
			...
			if (pos < maxPos) {
				...
				if (nextChar == '゛' || nextChar == '゜') {
					pos++;
					daku[KanaMapTable.INDEX_HANKAKU_BASE] = currChar;
					daku[KanaMapTable.INDEX_HANKAKU_DAKUTEN] = nextChar;
	...
	private static char[] convertH2ZKanaChar(char[] chars, char[][][] mapTable,
		...
		if (index >= 0) {
			return mapTable[index][KanaMapTable.INDEX_ZENKAKU];
	 ...
	 * @return
	 */
	public static String toTwoDigitString(Long num) {
		if (num != null) {
    ...
    public static String getNumToken(){
        return RandomStringKit.random(10, NUM_S);
    }
    ...
    public static String randomPwd(int count){
        return RandomStringKit.random(count, STR_S);
    }
}
