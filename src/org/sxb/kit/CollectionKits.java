 ...
 * @since 1.1.3
 */
public abstract class CollectionKits {
	 ...
	 * @see ObjectKits#toObjectArray(Object)
	 * @see Arrays#asList(Object[])
	 */
	@SuppressWarnings("rawtypes")
	public static List arrayToList(Object source) {
		return Arrays.asList(ObjectKits.toObjectArray(source));
	}
	...
	public static <E> void mergeArrayIntoCollection(Object array, Collection<E> collection) {
		...
		Object[] arr = ObjectKits.toObjectArray(array);
		for (Object elem : arr) {
	...
	public static boolean contains(Iterator<?> iterator, Object element) {
		if (iterator != null) {
			while (iterator.hasNext()) {
				...
				if (ObjectKits.nullSafeEquals(candidate, element)) {
					return true;
				}
			}
		}
	...
	public static Object findValueOfType(Collection<?> collection, Class<?>[] types) {
		if (isEmpty(collection) || ObjectKits.isEmpty(types)) {
			return null;
		}
