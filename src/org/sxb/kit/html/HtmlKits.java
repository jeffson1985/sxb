 ...
 */
public abstract class HtmlKits {
	...
	public static String htmlEscape(String input) {
		return htmlEscape(input, WebKits.DEFAULT_CHARACTER_ENCODING);
	}
	...
	public static String htmlEscapeDecimal(String input) {
		return htmlEscapeDecimal(input, WebKits.DEFAULT_CHARACTER_ENCODING);
	}
	...
	public static String htmlEscapeHex(String input) {
		return htmlEscapeHex(input, WebKits.DEFAULT_CHARACTER_ENCODING);
	}
