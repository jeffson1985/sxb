...
public class JdkLogger extends Logger {
	...
	public void debug(String message, Object... args) {
	    log.logp(Level.FINE, clazzName, Thread.currentThread().getStackTrace()[1].getMethodName(), String.format(message, args));
	}
	
	public void debug(String message, Throwable t, Object... args) {
	      log.logp(Level.FINE, clazzName, Thread.currentThread().getStackTrace()[1].getMethodName(), String.format(message, args), t);
	}
	...
	public void info(String message, Object... args) {
	    log.logp(Level.INFO, clazzName, Thread.currentThread().getStackTrace()[1].getMethodName(), String.format(message, args));
	}

	public void info(String message, Throwable t, Object... args) {
		log.logp(Level.INFO, clazzName, Thread.currentThread().getStackTrace()[1].getMethodName(), String.format(message, args), t);
	}
	...
	public void warn(String message, Object... args) {
	      log.logp(Level.WARNING, clazzName, Thread.currentThread().getStackTrace()[1].getMethodName(), String.format(message, args));
	}
	public void warn(String message, Throwable t, Object... args) {
	     log.logp(Level.WARNING, clazzName, Thread.currentThread().getStackTrace()[1].getMethodName(), String.format(message, args), t);
	}
	...
	public void error(String message, Object... args) {
	      log.logp(Level.SEVERE, clazzName, Thread.currentThread().getStackTrace()[1].getMethodName(), String.format(message, args));
	}
	
	public void error(String message, Throwable t, Object... args) {
	      log.logp(Level.SEVERE, clazzName, Thread.currentThread().getStackTrace()[1].getMethodName(), String.format(message, args), t);
	}
