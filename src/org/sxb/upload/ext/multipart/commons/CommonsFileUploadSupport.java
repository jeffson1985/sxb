...
public abstract class CommonsFileUploadSupport {
	...
	protected final Logger logger = Logger.getLogger(CommonsFileUploadSupport.class);
	...
	protected String getDefaultEncoding() {
		...
		if (encoding == null) {
			encoding = WebKits.DEFAULT_CHARACTER_ENCODING;
		}
		return encoding;
	}
	 ...
	 * @see org.sxb.webKits#TEMP_DIR_CONTEXT_ATTRIBUTE
	 */
		...
		for (FileItem fileItem : fileItems) {
			if (fileItem.isFormField()) {
				...
				if (curParam == null) {
					...
					String[] newParam = StringKits.addStringToArray(curParam, value);
	...
	private String determineEncoding(String contentTypeHeader, String defaultEncoding) {
		if (!StringKits.hasText(contentTypeHeader)) {
