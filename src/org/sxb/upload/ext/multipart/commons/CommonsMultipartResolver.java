...
import org.sxb.upload.ext.multipart.support.DefaultMultipartHttpServletRequest;
...
public class CommonsMultipartResolver extends CommonsFileUploadSupport
	...
	public void setServletContext(ServletContext servletContext) {
		if (!isUploadTempDirSpecified()) {
			getFileItemFactory().setRepository(WebKits.getTempDir(servletContext));
		}
	}
	...
	protected MultipartParsingResult parseRequest(HttpServletRequest request) throws MultipartException {
		...
		try {
			...
			//throw new MaxUploadSizeExceededException(fileUpload.getSizeMax(), 403, RenderFactory.me().getErrorRender(900));
			throw new MaxUploadSizeExceededException(fileUpload.getSizeMax(), 301, "error.html");
		}
