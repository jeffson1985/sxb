 ...
 * @author    Jeffson  (jeffson.app@gmail.com).1
 */
...
public class MaxUploadSizeExceededException extends MultipartException {
	...
	public MaxUploadSizeExceededException(long maxUploadSize, int errorCode, Render errorRender) {
		super(errorCode, errorRender);
		this.maxUploadSize = maxUploadSize;
	}
	
	public MaxUploadSizeExceededException(long maxUploadSize, int errorCode, String errorView) {
