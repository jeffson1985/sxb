...
final class OpaqueUriComponents extends UriComponents {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1823308373251626605L;
	...
	public boolean equals(Object obj) {
		...
		return ObjectKits.nullSafeEquals(getScheme(), other.getScheme()) &&
				ObjectKits.nullSafeEquals(this.ssp, other.ssp) &&
	...
	public int hashCode() {
		...
		result = 31 * result + ObjectKits.nullSafeHashCode(this.ssp);
