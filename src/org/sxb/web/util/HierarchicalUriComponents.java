...
import org.sxb.kit.LinkedMultiValueMap;
import org.sxb.kit.MultiValueMap;
...
final class HierarchicalUriComponents extends UriComponents {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7002182355365378469L;
	...
	HierarchicalUriComponents(String scheme, String userInfo, String host, String port, PathComponent path,
		...
		this.queryParams = CollectionKits.unmodifiableMultiValueMap(
	...
	public String getQuery() {
		if (!this.queryParams.isEmpty()) {
			...
			for (Map.Entry<String, List<String>> entry : this.queryParams.entrySet()) {
				...
				if (CollectionKits.isEmpty(values)) {
	 ...
	 * @see StringKits#cleanPath(String)
	 */
	@Override
	public UriComponents normalize() {
		String normalizedPath = StringKits.cleanPath(getPath());
	...
	public URI toUri() {
		try {
			if (this.encoded) {
				...
				String path = getPath();
				if (StringKits.hasLength(path) && path.charAt(0) != PATH_DELIMITER) {
	...
	public boolean equals(Object obj) {
		...
		return ObjectKits.nullSafeEquals(getScheme(), other.getScheme()) &&
				ObjectKits.nullSafeEquals(getUserInfo(), other.getUserInfo()) &&
				ObjectKits.nullSafeEquals(getHost(), other.getHost()) &&
				getPort() == other.getPort() &&
				this.path.equals(other.path) &&
				this.queryParams.equals(other.queryParams) &&
				ObjectKits.nullSafeEquals(getFragment(), other.getFragment());
	}

	@Override
	public int hashCode() {
		int result = ObjectKits.nullSafeHashCode(getScheme());
		result = 31 * result + ObjectKits.nullSafeHashCode(this.userInfo);
		result = 31 * result + ObjectKits.nullSafeHashCode(this.host);
		result = 31 * result + ObjectKits.nullSafeHashCode(this.port);
		result = 31 * result + this.path.hashCode();
		result = 31 * result + this.queryParams.hashCode();
		result = 31 * result + ObjectKits.nullSafeHashCode(getFragment());
		return result;
	}
	...
	static final class FullPathComponent implements PathComponent {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -3142618900522587270L;
		...
		public List<String> getPathSegments() {
			...
			String[] pathSegments = StringKits.tokenizeToStringArray(path, delimiter);
	...
	static final class PathSegmentComponent implements PathComponent {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 268771481500272181L;
	...
	static final class PathComponentComposite implements PathComponent {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -854008918591098142L;
	...
	static final PathComponent NULL_PATH_COMPONENT = new PathComponent() {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -812897719916764942L;
		@Override
		public String getPath() {
			return null;
		}
