...
import org.sxb.data.redis.connection.DefaultTuple;
import org.sxb.data.redis.connection.RedisListCommands.Position;
import org.sxb.data.redis.connection.RedisServer;
import org.sxb.data.redis.connection.RedisStringCommands.BitOperation;
import org.sxb.data.redis.connection.RedisZSetCommands.Range.Boundary;
import org.sxb.data.redis.connection.RedisZSetCommands.Tuple;
import org.sxb.data.redis.connection.SortParameters;
import org.sxb.data.redis.connection.SortParameters.Order;
import org.sxb.data.redis.connection.SortParameters.Range;
import org.sxb.data.redis.connection.convert.Converters;
import org.sxb.data.redis.connection.convert.ListConverter;
import org.sxb.data.redis.connection.convert.MapConverter;
import org.sxb.data.redis.connection.convert.SetConverter;
import org.sxb.data.redis.connection.convert.StringToRedisClientInfoConverter;
...
abstract public class JedisConverters extends Converters {
	...
	public static List<RedisServer> toListOfRedisServer(List<Map<String, String>> source) {
		...
		if (CollectionKits.isEmpty(source)) {
			return Collections.emptyList();
		}
