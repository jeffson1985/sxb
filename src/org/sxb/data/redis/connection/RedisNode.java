...
public class RedisNode implements NamedNode {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ObjectKits.nullSafeHashCode(host);
		result = prime * result + ObjectKits.nullSafeHashCode(port);
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!ObjectKits.nullSafeEquals(this.host, other.host)) {
			return false;
		}

		if (!ObjectKits.nullSafeEquals(this.port, other.port)) {
			return false;
		}

		if (!ObjectKits.nullSafeEquals(this.name, other.name)) {
			return false;
		}
