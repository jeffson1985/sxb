...
import org.sxb.convert.sp.InfrastructureProxy;
import org.sxb.convert.sp.ResourceTransactionManager;
import org.sxb.convert.sp.ScopedObject;
...
public abstract class TransactionSynchronizationUtils {
	...
	private static final Logger logger = Logger.getLogger(TransactionSynchronizationUtils.class);

	private static final boolean aopAvailable = ClassKits.isPresent(
			"org.sxb.data.redis.converter.ScopedObject", TransactionSynchronizationUtils.class.getClassLoader());
	 ...
	 * @see org.sxb.InfrastructureProxy#getWrappedObject()
	 */
