...
package org.sxb.data.redis.core.script.resource;
...
public class EncodedResource implements InputStreamSource {
	...
	public boolean equals(Object other) {
		...
		return (this.resource.equals(otherResource.resource) &&
				ObjectKits.nullSafeEquals(this.charset, otherResource.charset) &&
				ObjectKits.nullSafeEquals(this.encoding, otherResource.encoding));
	}
