...
public class HttpHeaders implements MultiValueMap<String, String>, Serializable {
	...
	public List<MediaType> getAccept() {
		...
		if (result.size() == 1) {
			...
			if (acceptHeader.size() > 1) {
				value = StringKits.collectionToCommaDelimitedString(acceptHeader);
	...
	public void setAllow(Set<HttpMethod> allowedMethods) {
		set(ALLOW, StringKits.collectionToCommaDelimitedString(allowedMethods));
	}
	...
	public MediaType getContentType() {
		...
		return (StringKits.hasLength(value) ? MediaType.parseMediaType(value) : null);
	}
