...
import org.sxb.kit.comparator.CompoundComparator;
...
public class MediaType extends MimeType implements Serializable {
	 ...
	 * (as supported by {@link org.sxb.data.redis.converter.convert.ConversionService}.
	...
	public static List<MediaType> parseMediaTypes(String mediaTypes) {
		if (!StringKits.hasLength(mediaTypes)) {
