...
public class HttpEntity<T> {
	...
	public boolean equals(Object other) {
		...
		return (ObjectKits.nullSafeEquals(this.headers, otherEntity.headers) &&
				ObjectKits.nullSafeEquals(this.body, otherEntity.body));
	}

	@Override
	public int hashCode() {
		return (ObjectKits.nullSafeHashCode(this.headers) * 29 + ObjectKits.nullSafeHashCode(this.body));
	}
