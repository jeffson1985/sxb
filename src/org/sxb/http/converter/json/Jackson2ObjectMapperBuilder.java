...
import org.sxb.bean.BeanInstantiationException;
import org.sxb.bean.FatalBeanException;
...
public class Jackson2ObjectMapperBuilder {
	...
	public Jackson2ObjectMapperBuilder locale(String localeString) {
		this.locale = StringKits.parseLocaleString(localeString);
		return this;
	}
	...
	public Jackson2ObjectMapperBuilder timeZone(String timeZoneString) {
		this.timeZone = StringKits.parseTimeZoneString(timeZoneString);
		return this;
	}
		...
		if (this.createXmlMapper) {
			try {
				Class<? extends ObjectMapper> xmlMapper = (Class<? extends ObjectMapper>)
						ClassKits.forName("com.fasterxml.jackson.dataformat.xml.XmlMapper", this.moduleClassLoader);
				objectMapper = instantiate(xmlMapper);
			}
	...
	public void configure(ObjectMapper objectMapper) {
		...
		if (this.moduleClasses != null) {
			for (Class<? extends Module> module : this.moduleClasses) {
				objectMapper.registerModule(instantiate(module));
			}
		}
	...
	private void registerWellKnownModulesIfAvailable(ObjectMapper objectMapper) {
		...
		if (ClassKits.isPresent("java.time.LocalDate", this.moduleClassLoader)) {
			try {
				Class<? extends Module> jsr310Module = (Class<? extends Module>)
						ClassKits.forName("com.fasterxml.jackson.datatype.jsr310.JSR310Module", this.moduleClassLoader);
				objectMapper.registerModule(instantiate(jsr310Module));
			}
			catch (ClassNotFoundException ex) {
		...
		// Joda-Time present?
		if (ClassKits.isPresent("org.joda.time.LocalDate", this.moduleClassLoader)) {
			try {
				Class<? extends Module> jodaModule = (Class<? extends Module>)
						ClassKits.forName("com.fasterxml.jackson.datatype.joda.JodaModule", this.moduleClassLoader);
				objectMapper.registerModule(instantiate(jodaModule));
			}
			catch (ClassNotFoundException ex) {
	 ...
	 */
	private  <T> T instantiate(Class<T> clazz) throws BeanInstantiationException {
