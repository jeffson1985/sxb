...
public class RequestEntity<T> extends HttpEntity<T> {
	...
	public boolean equals(Object other) {
		...
		return (ObjectKits.nullSafeEquals(this.method, otherEntity.method) &&
				ObjectKits.nullSafeEquals(this.url, otherEntity.url));
	}

	@Override
	public int hashCode() {
		int hashCode = super.hashCode();
		hashCode = 29 * hashCode + ObjectKits.nullSafeHashCode(this.method);
		hashCode = 29 * hashCode + ObjectKits.nullSafeHashCode(this.url);
		return hashCode;
	}
