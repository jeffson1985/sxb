...
import org.sxb.http.HttpStatus;
...
public class ServletServerHttpResponse implements ServerHttpResponse {
	...
	private static final boolean servlet3Present =
			ClassKits.hasMethod(HttpServletResponse.class, "getHeader", String.class);
	...
	private class ServletResponseHttpHeaders extends HttpHeaders {
		...
		public List<String> get(Object key) {
			...
			boolean isEmpty1 = CollectionKits.isEmpty(values1);

			List<String> values2 = super.get(key);
			boolean isEmpty2 = CollectionKits.isEmpty(values2);
