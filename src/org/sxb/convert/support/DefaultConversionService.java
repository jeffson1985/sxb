...
public class DefaultConversionService extends GenericConversionService {
	...
	private static final boolean javaUtilOptionalClassAvailable =
			ClassKits.isPresent("java.util.Optional", DefaultConversionService.class.getClassLoader());

	/** Java 8's java.time package available? */
	private static final boolean jsr310Available =
			ClassKits.isPresent("java.time.ZoneId", DefaultConversionService.class.getClassLoader());
	...
	private static void addCollectionConverters(ConverterRegistry converterRegistry) {
		...
		if (streamAvailable) {
			try {
				Class<?> clazz = ClassKits.forName("org.sxb.convert.support.StreamConverter", DefaultConversionService.class.getClassLoader());
				converterRegistry.addConverter((Converter<?, ?>)(clazz.getConstructor()).newInstance(conversionService));
