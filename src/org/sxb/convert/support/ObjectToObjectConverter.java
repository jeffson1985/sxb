...
final class ObjectToObjectConverter implements ConditionalGenericConverter {
	...
	private static Method getToMethod(Class<?> targetClass, Class<?> sourceClass) {
		Method method = ClassKits.getMethodIfAvailable(sourceClass, "to" + targetClass.getSimpleName());
	...
	private static Method getFactoryMethod(Class<?> targetClass, Class<?> sourceClass) {
		Method method = ClassKits.getStaticMethod(targetClass, "valueOf", sourceClass);
		if (method == null) {
			method = ClassKits.getStaticMethod(targetClass, "of", sourceClass);
			if (method == null) {
				method = ClassKits.getStaticMethod(targetClass, "from", sourceClass);
			}
		}
		return method;
	}
	...
	private static Constructor<?> getFactoryConstructor(Class<?> targetClass, Class<?> sourceClass) {
		return ClassKits.getConstructorIfAvailable(targetClass, sourceClass);
	}
