...
import static org.sxb.convert.sp.AnnotationUtils.getAttributeMethods;
import static org.sxb.convert.sp.AnnotationUtils.isAnnotationTypeMethod;
import static org.sxb.convert.sp.AnnotationUtils.isAttributeMethod;
import static org.sxb.convert.sp.AnnotationUtils.synthesizeAnnotation;
import static org.sxb.convert.sp.AnnotationUtils.synthesizeAnnotationArray;
import static org.sxb.kit.ReflectionKits.invokeMethod;
import static org.sxb.kit.ReflectionKits.isEqualsMethod;
import static org.sxb.kit.ReflectionKits.isHashCodeMethod;
import static org.sxb.kit.ReflectionKits.isToStringMethod;
...
class SynthesizedAnnotationInvocationHandler implements InvocationHandler {
	...
	private boolean annotationEquals(Object other) {
		...
		for (Method attributeMethod : getAttributeMethods(annotationType())) {
			...
			if (!ObjectKits.nullSafeEquals(thisValue, otherValue)) {
				return false;
			}
		}
	 ...
	 * in Spring's {@link ObjectKits} because those hash code generation
	...
	private String attributeValueToString(Object value) {
		if (value instanceof Object[]) {
			return "[" + StringKits.arrayToDelimitedString((Object[]) value, ", ") + "]";
		}
