...
public class AnnotationAttributes extends LinkedHashMap<String, Object> {
	...
	private <T> T getRequiredAttributeWithAlias(String attributeName, Class<? extends Annotation> annotationType,
		...
		boolean attributeDeclared = !ObjectKits.isEmpty(attributeValue);
		boolean aliasDeclared = !ObjectKits.isEmpty(aliasValue);

		if (!ObjectKits.nullSafeEquals(attributeValue, aliasValue) && attributeDeclared && aliasDeclared) {
			...
			String msg = String.format("In annotation [%s] declared on [%s], attribute [%s] and its alias [%s] " +
					...
					ObjectKits.nullSafeToString(attributeValue), ObjectKits.nullSafeToString(aliasValue));
