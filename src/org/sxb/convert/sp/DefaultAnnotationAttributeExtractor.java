...
class DefaultAnnotationAttributeExtractor extends AbstractAliasAwareAnnotationAttributeExtractor<Annotation> {
	...
	protected Object getRawAttributeValue(Method attributeMethod) {
		ReflectionKits.makeAccessible(attributeMethod);
		return ReflectionKits.invokeMethod(attributeMethod, getSource());
	}

	@Override
	protected Object getRawAttributeValue(String attributeName) {
		Method attributeMethod = ReflectionKits.findMethod(getAnnotationType(), attributeName);
