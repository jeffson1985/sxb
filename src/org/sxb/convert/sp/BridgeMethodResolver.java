...
public abstract class BridgeMethodResolver {
	...
	public static Method findBridgedMethod(Method bridgeMethod) {
		...
		Method[] methods = ReflectionKits.getAllDeclaredMethods(bridgeMethod.getDeclaringClass());
	...
	private static Method findGenericDeclaration(Method bridgeMethod) {
		...
		// Search interfaces.
		Class<?>[] interfaces = ClassKits.getAllInterfacesForClass(bridgeMethod.getDeclaringClass());
	...
	private static Method searchForMatch(Class<?> type, Method bridgeMethod) {
		return ReflectionKits.findMethod(type, bridgeMethod.getName(), bridgeMethod.getParameterTypes());
	}
