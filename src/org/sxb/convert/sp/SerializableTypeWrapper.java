...
abstract class SerializableTypeWrapper {
	...
	private static final Method EQUALS_METHOD = ReflectionKits.findMethod(Object.class,
			"equals", Object.class);

	private static final Method GET_TYPE_PROVIDER_METHOD = ReflectionKits.findMethod(
	...
	static class MethodInvokeTypeProvider implements TypeProvider {
		...
		public MethodInvokeTypeProvider(TypeProvider provider, Method method, int index) {
			...
			this.index = index;
			this.result = ReflectionKits.invokeMethod(method, provider.getType());
		}
		...
		private void readObject(ObjectInputStream inputStream) throws IOException, ClassNotFoundException {
			inputStream.defaultReadObject();
			Method method = ReflectionKits.findMethod(this.provider.getType().getClass(), this.methodName);
			this.result = ReflectionKits.invokeMethod(method, this.provider.getType());
		}
	}
