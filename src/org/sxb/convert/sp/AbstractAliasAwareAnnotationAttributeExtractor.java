...
abstract class AbstractAliasAwareAnnotationAttributeExtractor<S> implements AnnotationAttributeExtractor<S> {
	...
	public final Object getAttributeValue(Method attributeMethod) {
		...
		if (aliasName != null) {
			...
			if (!ObjectKits.nullSafeEquals(attributeValue, aliasValue) &&
					!ObjectKits.nullSafeEquals(attributeValue, defaultValue) &&
					!ObjectKits.nullSafeEquals(aliasValue, defaultValue)) {
			...
			if (ObjectKits.nullSafeEquals(attributeValue, defaultValue)) {
