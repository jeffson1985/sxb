 ...
 * @version $Id: SendMailImpl.java,v 1.4
 */
public class SendMailImpl implements SendMail {

	private static Logger log = Logger.getLogger(SendMailImpl.class);
	 ...
	 * 送信時にタイムアウトすると、<code>org.sxb.mail.MailSendException</code>がスローされます。
	 * <p>
	 * -1を指定すると無限大になりますが、お薦めしません。
	 * 
	 * @since 1.1.4
	 ...
	 * @version $Id: SendMailImpl.java,v 1.7.2.6 2007/03/30 13:03:44 
	 */
