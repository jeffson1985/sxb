...
public class SimpleMailMessage implements MailMessage, Serializable {
	...
	public String toString() {
		...
		sb.append("to=").append(StringKits.arrayToCommaDelimitedString(this.to)).append("; ");
		sb.append("cc=").append(StringKits.arrayToCommaDelimitedString(this.cc)).append("; ");
		sb.append("bcc=").append(StringKits.arrayToCommaDelimitedString(this.bcc)).append("; ");
	...
	public boolean equals(Object other) {
		...
		return (ObjectKits.nullSafeEquals(this.from, otherMessage.from) &&
				ObjectKits.nullSafeEquals(this.replyTo, otherMessage.replyTo) &&
				...
				ObjectKits.nullSafeEquals(this.sentDate, otherMessage.sentDate) &&
				ObjectKits.nullSafeEquals(this.subject, otherMessage.subject) &&
				ObjectKits.nullSafeEquals(this.text, otherMessage.text));
	}
