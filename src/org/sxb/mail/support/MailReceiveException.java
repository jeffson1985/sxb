...
public class MailReceiveException extends MailException {
	 ...
	 */
	public MailReceiveException(String msg) {
		this(msg, null);
	}
	 ...
	 */
	public MailReceiveException(String msg, Throwable cause) {
		super(msg, cause);
	 ...
	 */
	public MailReceiveException(String msg, Throwable cause, Map<Object, Exception> failedMessages) {
		super(msg, cause);
	...
	public String getMessage() {
		if (ObjectKits.isEmpty(this.messageExceptions)) {
