 ...
 */
public class QuartzOnceJob<M extends Job> extends QuartzJob<M> {

  private Date startTime;

  public QuartzOnceJob(String name, Date startTime, Class<M> jobClass) {
    this(Quartzer.nextKey(name), startTime, jobClass);
  }

  public QuartzOnceJob(String group, String name, Date startTime, Class<M> jobClass) {
    this(Quartzer.nextKey(group, name), startTime, jobClass);
  }

  public QuartzOnceJob(QuartzKey quartzKey, Date startTime, Class<M> jobClass) {
