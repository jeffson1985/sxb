 ...
 * {@link org.sxb.io.ResourceLoader}'s {@code getResource()}
 * method can resolve any location to a {@link org.sxb.io.Resource}
 ...
 * @since 1.1.5
 * @see org.sxb.io.Resource
 * @see org.sxb.io.ClassPathResource
 * @see org.sxb.io.FileSystemResource
 * @see org.sxb.io.UrlResource
 * @see org.sxb.io.ResourceLoader
 */
public abstract class ResourceKits {
	...
	public static URL getURL(String resourceLocation) throws FileNotFoundException {
		...
		if (resourceLocation.startsWith(CLASSPATH_URL_PREFIX)) {
			...
			ClassLoader cl = ClassKits.getDefaultClassLoader();
	...
	public static URI toURI(String location) throws URISyntaxException {
		return new URI(StringKits.replace(location, " ", "%20"));
	}
