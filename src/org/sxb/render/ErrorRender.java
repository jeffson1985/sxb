...
public class ErrorRender extends Render {
	...
	protected static final String version = "<center><a href='http://www.cetvision.com?f=ev' target='_blank'><b>Powered by Sxb " + Const.SXB_VERSION + "</b></a></center>";
	...
	protected static final String html301 = "<html><head><title>upload size exceeded error</title></head><body bgcolor='white'><center><h1>Ulpload Forbidden</h1></center><hr>" + version + "</body></html>";
