...
import org.sxb.lang.UsesJava7;
import org.sxb.bean.FactoryBean;
import org.sxb.core.scheduling.support.DelegatingErrorHandlingRunnable;
...
/**
 * {@link org.sxb.beans.factory.FactoryBean} that sets up
...
public class ScheduledExecutorFactoryBean extends ExecutorConfigurationSupport
	...
	private static final boolean setRemoveOnCancelPolicyAvailable =
			ClassKits.hasMethod(ScheduledThreadPoolExecutor.class, "setRemoveOnCancelPolicy", boolean.class);
	...
	protected ExecutorService initializeExecutor(
		...
		if (!ObjectKits.isEmpty(this.scheduledExecutorTasks)) {
	 ...
	 * {@link org.sxb.scheduling.support.DelegatingErrorHandlingRunnable}
