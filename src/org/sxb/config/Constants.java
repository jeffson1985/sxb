...
import org.sxb.i18n.I18n;
import org.sxb.kit.PathKit;
import org.sxb.kit.StrKit;
import org.sxb.log.ILoggerFactory;
import org.sxb.log.Logger;
import org.sxb.render.IErrorRenderFactory;
import org.sxb.render.IMainRenderFactory;
...
final public class Constants {
	...
	private String defaultSxbConfigName = Const.DEFATLT_SXB_CONFIG_NAME;
	
	private ITokenCache tokenCache;
	
	/**
	 * Set ITokenCache implementation otherwise Sxb will use the HttpSesion to hold the token.
	...
	/**
	 * Set the error render factory
	 * @param errorRenderFactory
	 */
	...
	/**
	 * Set the file upload rename policy
	 * @param myFilerenamePolicy
	 */
	public void setFileRenamePolicy(SxbFileRenamePolicy myFilerenamePolicy){
		MultipartRequest.setFileRenamePolicy(myFilerenamePolicy);
	}
	
	/**
	 * Set allowed upload file type
	 * @param postfixes
	 */
	public void addAllowUploadFileType(String ... suffixes){
		MultipartRequest.addAllowUploadFileType(suffixes);
	}
	/**
	 * Add allowed upload file type
	 * @param postfixes
	 */
	public void setAllowUploadFileType(Set<String> suffixes){
		MultipartRequest.setAllowUploadFileType(suffixes);
	}
	
	public String getDefaultSxbConfigName(){
		return defaultSxbConfigName;
	}
}
